...
if($sort == 'price_asc'){
	...
	//$orderBy = "ORDER BY (CASE WHEN status = 'available' THEN 0 ELSE 1 END), daily_rate ASC";
	$orderBy = "WHERE NOT status = 'booked'";
} else {
    // Default: available cars first then by ascending price.
    $orderBy = "";
}

$query = "SELECT * FROM cars $orderBy";
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="car.php" class="nav-tem nav-link active">Cars</a>
