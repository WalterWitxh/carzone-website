<?php
session_start();
// Check that the admin is logged in. In our login.php, when the admin logs in,
// we set $_SESSION['admin'] to true.
      ...
      <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
        ...
        <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
          <div class="navbar-nav ml-auto py-0">
            ...
            <a href="admin_notifications.php" class="nav-item nav-link">Notification</a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Welcome,Admin!</h4>
                            <h1 class="display-1 text-white mb-md-4">Admin Dashboard</h1>
                            <p class="text-white-50">This is your dashboard where you can view all orders, manage vehicle statuses, and more.</p>
                            
                            <a href="admin_orders.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Orders</a>
                            <a href="admin_notifications.php" class="btn btn-success py-md-3 px-md-5 mt-2">Notification</a>
                        </div>
                    </div>
                </div>
